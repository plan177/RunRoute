...
- [ ] Любой → Track: маршрут очищается
- [ ] При переключении предлагается поделиться маршрутом
...
- Социальные функции (рейтинг, история, шаринг между пользователями) не реализованы
